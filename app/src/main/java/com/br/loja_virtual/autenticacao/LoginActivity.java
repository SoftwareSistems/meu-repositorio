...
import com.br.loja_virtual.activity.loja.MainActivityEmpresa;
import com.br.loja_virtual.activity.usuario.MainActivityUsuario;
import com.br.loja_virtual.databinding.ActivityLoginBinding;
        ...
        usuarioRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){ // Usuário
                    //finish(); descomentar somente para configuração da loja
                    setResult(RESULT_OK); //comentar para configuração da loja
                    startActivity(new Intent(getBaseContext(), MainActivityUsuario.class));//remover depois
                }else {//  Loja
                    startActivity(new Intent(getBaseContext(), MainActivityEmpresa.class));
                }
                finish(); //comentar para configuração da loja
            }
